...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    onFileChange: function onFileChange(event) {
      ...
      console.log(event); // 何も選択されていなかったら処理中断
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                if (!(response.stauts === _util__WEBPACK_IMPORTED_MODULE_1__["UNPROCESSABLE_ENTITY"])) {
                  _context2.next = 6;
                  break;
                }

                _this2.commentErrors = response.data.commentErrors;
                return _context2.abrupt("return", false);

              case 6:
                _this2.commentContent = '';
                _this2.commentErrors = null; // その他エラー
        ...
        [
          _c("div", { staticClass: "photo__controls" }, [
            ...
            _c(
              ...
              [_c("i", { staticClass: "icon icon-md-arrow-round-down" })]
            )
          ]),
          _vm._v(" "),
...
window.axios.interceptors.request.use(function (config) {
  ...
  config.headers['X-CSRF-TOKEN'] = Object(_util__WEBPACK_IMPORTED_MODULE_0__["getCookieValue"])('XSRF-TOKEN');
  return config;
});
...
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./store */ "./resources/js/store/index.js");
 ...
 // VueRouterプラグインを使用する
// これによってRouterViewコンポーネントなどを使うことができる
